...
<div class="rounded-xl p-4 bg-white shadow-smd border">
    ...
    <div class="text-sm text-gray-500 mb-3">
        Dashboard › <span class="font-semibold text-gray-700">Contacts message</span>
    </div>
    ...
    <table class="w-full border border-gray-300 text-sm text-gray-700">
        ...
        <tbody>
            <tr class="border-b">
                ...
                <td class="p-2 border">
                    Bonjour, je voudrais avoir plus d’informations sur vos services.
                </td>
